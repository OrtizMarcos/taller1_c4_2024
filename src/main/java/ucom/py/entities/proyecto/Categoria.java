...
public class Categoria implements Serializable {
    ...
    public Categoria(Integer idCategoria, String codigo, String descripcion, String tipoCategoria) {
        this.idCategoria = idCategoria;
        this.codigo = codigo;
    ...
    public String toString() {
        return "py.edu.ucom.entities.proyecto.Categoria[ idCategoria=" + idCategoria + " ]";
    }
